...
export default function BoardDashboard() {
    ...
    const fetchAllData = async () => {
        ...
        try {
            ...
            // Filter for Tier 3 and Insider loans requiring Board approval
            setLoanApplications(loansRes.data.filter((l: any) => ((l.principal_amount || l.amount) > 5000000 || l.is_insider_loan) && l.approved_by != null))
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Credit Committee</h1>
                    <p className="mt-1 text-sm text-gray-500 dark:text-slate-400">
                        Tier 3 & Insider Loan Approvals
                    </p>
                </div>
